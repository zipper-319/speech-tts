...
type TtsReq struct {
	...
	SpeakingType         string `protobuf:"bytes,16,opt,name=speaking_type,json=speakingType,proto3" json:"speaking_type,omitempty"`
}
...
func (x *TtsReq) GetSpeakingType() string {
	if x != nil {
		return x.SpeakingType
	}
	return ""
}
...
var file_tts_v1_schema_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa3, 0x04, 0x0a, 0x06, 0x54, 0x74, 0x73, 0x52, 0x65, 0x71, 0x12,
	...
	0x67, 0x75, 0x61, 0x67, 0x65, 0x12, 0x23, 0x0a, 0x0d, 0x73, 0x70, 0x65, 0x61, 0x6b, 0x69, 0x6e,
	0x67, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x10, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x73, 0x70,
	0x65, 0x61, 0x6b, 0x69, 0x6e, 0x67, 0x54, 0x79, 0x70, 0x65, 0x22, 0xd4, 0x02, 0x0a, 0x06, 0x54,
