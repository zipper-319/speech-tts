...
const (
	CloudMindsTTS_Call_FullMethodName       = "/schema.CloudMindsTTS/Call"
	CloudMindsTTS_GetVersion_FullMethodName = "/schema.CloudMindsTTS/GetVersion"
	CloudMindsTTS_MixCall_FullMethodName    = "/schema.CloudMindsTTS/MixCall"
	CloudMindsTTS_GetSpeaker_FullMethodName = "/schema.CloudMindsTTS/GetSpeaker"
)
...
func (c *cloudMindsTTSClient) MixCall(ctx context.Context, in *MixTtsReq, opts ...grpc.CallOption) (CloudMindsTTS_MixCallClient, error) {
	stream, err := c.cc.NewStream(ctx, &CloudMindsTTS_ServiceDesc.Streams[1], CloudMindsTTS_MixCall_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *cloudMindsTTSClient) GetSpeaker(ctx context.Context, in *VerReq, opts ...grpc.CallOption) (*SpeakerList, error) {
	out := new(SpeakerList)
	err := c.cc.Invoke(ctx, CloudMindsTTS_GetSpeaker_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CloudMindsTTS_GetSpeaker_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CloudMindsTTS_GetSpeaker_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
